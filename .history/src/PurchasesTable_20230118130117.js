...
function PurchasesTable() {
  ...
  if (customer) {
    ...
    productsToShow.forEach(data=>{
      dataToShow.customersData.push(customers.filter(customers=>customers.id===data.CustomerID))
      console.log(dataToShow.customersData)
      customerToShow=dataToShow.map(x=>x.customerToShow)
    })
