...
function PurchasesTable() {
  ...
  if (customer) {
   ...
   // customerToShow = customers.filter((customers) => customers.id === productsToShow.filter(x=>x.CustomerID===customers.id))
   productsToShow.forEach(element => {
    customerToShow = customers.filter((customers,element) => customers.id === element.CustomerID)
   });
    dateToShow = productsToShow
    if(date)
    {
