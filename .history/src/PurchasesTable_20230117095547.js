...
function PurchasesTable() {
  ...
  if (customer) {
    ...
    //productsToShow.forEach((x)=>{ customerToShow = customers.filter((customers) => customers.id === x.CustomerID)})
    customerToShow = customers.filter((customers,productsToShow) => productsToShow.filter(x=>x.CustomerID===customers.id))
